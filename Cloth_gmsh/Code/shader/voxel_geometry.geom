...
void main()
{
  ...
  for (j = j_min; j < j_max; j++)
  {
    ...
    // COMPUTING BILLBOARD:
    A = vec4(-s*base.x/AR, -s*base.y, 0.0, 0.0);                                // Computing offset point A (in clip space)...
    B = vec4(+s*base.x/AR, +s*base.y, 0.0, 0.0);                                // Computing offset point B (in clip space)...
    C = vec4(-s*base.x/AR, -s*base.y, 0.0, 0.0);                                // Computing offset point C (in clip space)...
    D = vec4(+s*base.x/AR, +s*base.y, 0.0, 0.0);                                // Computing offset point D (in clip space)...
