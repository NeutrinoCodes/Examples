...
int main ()
{
  ...
  neighbours    = cloth->neighbour (2, 10, NU_MSH_TRI_3).size ();                                    // Getting number of neighbours...
  ...
  for(i = 0; i < nodes; i++)
  {
    ...
    pos_x = cloth->node (2, 10, NU_MSH_TRI_3)[i].x;                                                  // Getting cloth node "x" position...
    pos_y = cloth->node (2, 10, NU_MSH_TRI_3)[i].y;                                                  // Getting cloth node "y" position...
    pos_z = cloth->node (2, 10, NU_MSH_TRI_3)[i].z;                                                  // Getting cloth node "z" position...
    ...
    offset->data.push_back (cloth->neighbour (2, 10, NU_MSH_TRI_3)[i].offset);                       // Setting neighbour offset...
  }
