...
int main ()
{
  ...
  K1->setarg (stiffness, 2);                                                                        // Setting stiffness kernel argument...
  K1->setarg (position_int, 3);                                                                     // Setting intermediate position kernel argument...
  K1->setarg (velocity, 4);                                                                         // Setting velocity kernel argument...
  K1->setarg (velocity_int, 5);                                                                     // Setting intermediate velocity kernel argument...
  K1->setarg (acceleration, 6);                                                                     // Setting acceleration kernel argument...
  ...
  K2->setarg (stiffness, 2);                                                                        // Setting stiffness kernel argument...
  K2->setarg (position_int, 3);                                                                     // Setting intermediate position kernel argument...
  K2->setarg (velocity, 4);                                                                         // Setting velocity kernel argument...
  K2->setarg (velocity_int, 5);                                                                     // Setting intermediate velocity kernel argument...
  K2->setarg (acceleration, 6);                                                                     // Setting acceleration kernel argument...
  ...
  Q->write (stiffness, 2);                                                                          // Writing stiffness data on queue...
  Q->write (position_int, 3);                                                                       // Writing intermediate position data on queue...
  Q->write (velocity, 4);                                                                           // Writing velocity data on queue...
  Q->write (velocity_int, 5);                                                                       // Writing intermediate velocity data on queue...
  Q->write (acceleration, 6);                                                                       // Writing acceleration data on queue...
  ...
  S->setarg (stiffness, 2);                                                                         // Setting shader argument "2"...
  ...
  while(!gui->closed ())                                                                            // Opening window...
  {
    ...
    Q->acquire (stiffness, 2);                                                                      // Acquiring OpenGL/CL shared argument...
    ...
    Q->release (stiffness, 2);                                                                      // Releasing OpenGL/CL shared argument...
