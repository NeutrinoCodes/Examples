...
int main ()
{
  ...
  std::cout << "elements = " << elements << std::endl;                                               // Printing message...
  std::cout << "groups = " << groups << std::endl;                                                   // Printing message...
  std::cout << "neighbours = " << neighbours << std::endl;                                           // Printing message...
  std::cout << "offsets = " << cloth->neighbour_offset.size () << std::endl;                         // Printing message...
  std::cout << "lenghts = " << cloth->neighbour_length.size () << std::endl;                         // Printing message...
  std::cout << "links = " << cloth->neighbour_link.size () << std::endl;                             // Printing message...
