...
int main ()
{
  ...
  nu_int*             neighbour          = new nu_int ();                                           // Neighbour.
  ...
  K1->setarg (neighbour, 11);                                                                       // Setting neighbour kernel argument...
  ...
  K2->setarg (neighbour, 11);                                                                       // Setting neighbour kernel argument...
  ...
  Q->write (neighbour, 11);                                                                         // Writing neighbour on queue...
