...
int main ()
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  // MESH:
  nodes         = cloth->node[NU_MSH_TRI_3].size ();                                                 // Getting number of nodes...
  std::cout << "nodes = " << nodes << std::endl;
  neighbours    = cloth->neighbourhood[NU_MSH_TRI_3].size ();                                        // Getting number of neighbours nodes...
  elements      = cloth->element[NU_MSH_TRI_3].size ();                                              // Getting number of elements...
  ...
  for(i = 0; i < nodes; i++)
  {
    pos_x = cloth->node[NU_MSH_TRI_3][i].x;                                                          // Getting cloth node "x" position...
    pos_y = cloth->node[NU_MSH_TRI_3][i].y;                                                          // Getting cloth node "y" position...
    pos_z = cloth->node[NU_MSH_TRI_3][i].z;                                                          // Getting cloth node "z" position...
    ...
    offset->data.push_back (cloth->offset[NU_MSH_TRI_3][i]);
  }

  // SETTING NEUTRINO ARRAYS ("neighbours" depending):
  for(i = 0; i < neighbours; i++)
  {
    neighbour->data.push_back (cloth->neighbourhood[NU_MSH_TRI_3][i]);
    link_x = cloth->link[NU_MSH_TRI_3][i].x;
    link_y = cloth->link[NU_MSH_TRI_3][i].y;
    link_z = cloth->link[NU_MSH_TRI_3][i].z;
