...
int main ()
{
  ...
  gravity->data.push_back (
  {
    0.0f,                                                                                           // Setting gravity x component...
    0.0f,                                                                                           // Setting gravity y component...
    -g,                                                                                             // Setting gravity z component...
    1.0f                                                                                            // Setting gravity w component...
  }
                          );
  ...
  for(i = 0; i < nodes; i++)
  {
    ...
    {
      0.01f*(rand () % 100),                                                                        // Setting "r" color coordinate...
      0.01f*(rand () % 100),                                                                        // Setting "g" color coordinate...
      0.01f*(rand () % 100),                                                                        // Setting "b" color coordinate...
      1.0f                                                                                          // Setting "a" color coordinate...
    }
                          );

    position->data.push_back (
    {
      object->node[i].x,                                                                            // Setting "x" position...
      object->node[i].y,                                                                            // Setting "y" position...
      object->node[i].z,                                                                            // Setting "z" position...
      object->node[i].w                                                                             // Setting "w" position...
    }
                             );
