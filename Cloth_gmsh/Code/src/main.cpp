...
int main ()
{
  ...
  while(!gui->closed ())                                                                            // Opening window...
  {
    ...
    Q->release (resting, 7);                                                                        // Releasing OpenGL/CL shared argument...
    Q->release (friction, 7);                                                                       // Releasing OpenGL/CL shared argument...
    Q->release (mass, 7);                                                                           // Releasing OpenGL/CL shared argument...
    Q->release (nearest, 7);                                                                        // Releasing OpenGL/CL shared argument...
    Q->release (offset, 7);                                                                         // Releasing OpenGL/CL shared argument...
    Q->release (freedom, 7);                                                                        // Releasing OpenGL/CL shared argument...
    Q->release (dt, 7);                                                                             // Releasing OpenGL/CL shared argument...
