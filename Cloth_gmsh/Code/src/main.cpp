...
int main ()
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  // MESH:
  cloth->get_nodes (2, 10);                                                                          // Getting nodes...
  position->data = cloth->node;
  cloth->get_nodes (1, 100);                                                                         // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (1, 200);                                                                         // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (1, 300);                                                                         // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (1, 400);                                                                         // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (0, 10);                                                                          // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (0, 20);                                                                          // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (0, 30);                                                                          // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
  cloth->get_nodes (0, 40);                                                                          // Getting nodes...
  position->data.insert (position->data.end (), cloth->node.begin (), cloth->node.end ());           // Adding nodes...
