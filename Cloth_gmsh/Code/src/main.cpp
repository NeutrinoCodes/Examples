...
int main ()
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  std::cout << "context = " << neutrino::context_id << std::endl;
  ...
  K1->build (kernel_sx, kernel_sy, kernel_sz);                                                      // Building kernel program...

  K2->addsource (std::string (KERNEL_HOME) + std::string (KERNEL_2));                               // Setting kernel source file...
  K2->build (kernel_sx, kernel_sy, kernel_sz);                                                      // Building kernel program...
