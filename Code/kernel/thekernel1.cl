                        ...
                        __global float*     dt_simulation)                      // Simulation time step [s].
{
  ...
  P = position[gid];                                                            // Getting point coordinates [m]...
  col = depth[gid];                                                             // Getting color coordinates [#]...
  ...
  P_R = position[n_R];                                                          // Setting right neighbour position coordinates [m]...
  P_U = position[n_U];                                                          // Setting up neighbour position coordinates [m]...
  P_L = position[n_L];                                                          // Setting left neighbour position coordinates [m]...
  P_D = position[n_D];                                                          // Setting down neighbour position coordinates [m]...
