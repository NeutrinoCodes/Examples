...
void setup()
{
  ...
  set_float4(velocity, 2);                                                      // Setting kernel argument #3...
  set_float4(acceleration, 3);                                                  // Setting kernel argument #4...
  set_float4(gravity, 4);                                                       // Setting kernel argument #5...
  set_float4(stiffness, 5);                                                     // Setting kernel argument #6...
  set_float4(resting, 6);                                                       // Setting kernel argument #7...
  set_float4(friction, 7);                                                      // Setting kernel argument #8...
  set_float4(mass, 8);                                                          // Setting kernel argument #9...
  set_int1(index_PR, 9);                                                       // Setting kernel argument #11...
  set_int1(index_PU, 10);                                                       // Setting kernel argument #12...
  set_int1(index_PL, 11);                                                       // Setting kernel argument #13...
  set_int1(index_PD, 12);                                                       // Setting kernel argument #14...
  set_float4(freedom, 13);
}
...
void loop()
{
  ...
  push_float4(&velocity->buffer, 2);                                            // Pushing kernel argument #3...
  push_float4(&acceleration->buffer, 3);                                        // Pushing kernel argument #4...
  push_float4(&gravity->buffer, 4);                                             // Pushing kernel argument #5...
  push_float4(&stiffness->buffer, 5);                                           // Pushing kernel argument #6...
  push_float4(&resting->buffer, 6);                                             // Pushing kernel argument #7...
  push_float4(&friction->buffer, 7);                                            // Pushing kernel argument #8...
  push_float4(&mass->buffer, 8);                                                // Pushing kernel argument #9...
  push_int1(&index_PR->buffer, 9);                                             // Pushing kernel argument #11...
  push_int1(&index_PU->buffer, 10);                                             // Pushing kernel argument #12...
  push_int1(&index_PL->buffer, 11);                                             // Pushing kernel argument #13...
  push_int1(&index_PD->buffer, 12);                                             // Pushing kernel argument #14...
  push_float4(&freedom->buffer, 13);

  execute_kernel();

  pop_point4(&position->buffer, 0);                                             // Pushing kernel argument #0...
  pop_color4(&color->buffer, 1);                                                // Pushing kernel argument #1...
  pop_float4(&velocity->buffer, 2);                                             // Pushing kernel argument #3...
  pop_float4(&acceleration->buffer, 3);                                         // Pushing kernel argument #4...
  pop_float4(&gravity->buffer, 4);                                              // Pushing kernel argument #5...
  pop_float4(&stiffness->buffer, 5);                                            // Pushing kernel argument #6...
  pop_float4(&resting->buffer, 6);                                              // Pushing kernel argument #7...
  pop_float4(&friction->buffer, 7);                                             // Pushing kernel argument #8...
  pop_float4(&mass->buffer, 8);                                                 // Pushing kernel argument #9...
  pop_int1(&index_PR->buffer, 9);                                              // Pushing kernel argument #11...
  pop_int1(&index_PU->buffer, 10);                                              // Pushing kernel argument #12...
  pop_int1(&index_PL->buffer, 11);                                              // Pushing kernel argument #13...
  pop_int1(&index_PD->buffer, 12);                                              // Pushing kernel argument #14...
  pop_float4(&freedom->buffer, 13);
