...
void setup()
{
  ...
  k1->source_file = KERNEL_FILE;                                                  // Setting OpenCL kernel source file...
  k1->size = NUM_POINTS;                                                        // Setting kernel size...
  k1->dimension = 1;                                                            // Setting kernel dimension...
  k1->init();

  k2->source_file = KERNEL_FILE;                                                  // Setting OpenCL kernel source file...
  ...
  velocity->set(k1, 2);                                                         // Setting kernel argument #3...
  acceleration->set(k1, 3);                                                     // Setting kernel argument #4...
  gravity->set(k1, 4);                                                          // Setting kernel argument #5...
  stiffness->set(k1, 5);                                                        // Setting kernel argument #6...
  resting->set(k1, 6);                                                          // Setting kernel argument #7...
  friction->set(k1, 7);                                                         // Setting kernel argument #8...
  mass->set(k1, 8);                                                             // Setting kernel argument #9...
  index_PR->set(k1, 9);                                                        // Setting kernel argument #11...
  index_PU->set(k1, 10);                                                        // Setting kernel argument #12...
  index_PL->set(k1, 11);                                                        // Setting kernel argument #13...
  index_PD->set(k1, 12);                                                        // Setting kernel argument #14...
  freedom->set(k1, 13);                                                         // Setting kernel argument #15...

  position->set(k2, 0);                                                         // Setting kernel argument #0...
  color->set(k2, 1);                                                            // Setting kernel argument #1...
  velocity->set(k2, 2);                                                         // Setting kernel argument #3...
  acceleration->set(k2, 3);                                                     // Setting kernel argument #4...
  gravity->set(k2, 4);                                                          // Setting kernel argument #5...
  stiffness->set(k2, 5);                                                        // Setting kernel argument #6...
  resting->set(k2, 6);                                                          // Setting kernel argument #7...
  friction->set(k2, 7);                                                         // Setting kernel argument #8...
  mass->set(k2, 8);                                                             // Setting kernel argument #9...
  index_PR->set(k2, 9);                                                        // Setting kernel argument #11...
  index_PU->set(k2, 10);                                                        // Setting kernel argument #12...
  index_PL->set(k2, 11);                                                        // Setting kernel argument #13...
  index_PD->set(k2, 12);                                                        // Setting kernel argument #14...
  freedom->set(k2, 13);                                                         // Setting kernel argument #15...
}
...
void loop()
{
  ...
  velocity->push(q1, k1, 2);                                                     // Pushing kernel argument #3...
  acceleration->push(q1, k1, 3);                                                 // Pushing kernel argument #4...
  gravity->push(q1, k1, 4);                                                      // Pushing kernel argument #5...
  stiffness->push(q1, k1, 5);                                                    // Pushing kernel argument #6...
  resting->push(q1, k1, 6);                                                      // Pushing kernel argument #7...
  friction->push(q1, k1, 7);                                                     // Pushing kernel argument #8...
  mass->push(q1, k1, 8);                                                         // Pushing kernel argument #9...
  index_PR->push(q1, k1, 9);                                                    // Pushing kernel argument #11...
  index_PU->push(q1, k1, 10);                                                    // Pushing kernel argument #12...
  index_PL->push(q1, k1, 11);                                                    // Pushing kernel argument #13...
  index_PD->push(q1, k1, 12);                                                    // Pushing kernel argument #14...
  freedom->push(q1, k1, 13);                                                     // Pushing kernel argument #15...

  k1->execute(q1, WAIT);

  position->pop(q1, k1, 0);                                                      // Popping kernel argument #0...
  color->pop(q1, k1, 1);                                                         // Popping kernel argument #1...
  velocity->pop(q1, k1, 2);                                                      // Popping kernel argument #3...
  acceleration->pop(q1, k1, 3);                                                  // Popping kernel argument #4...
  gravity->pop(q1, k1, 4);                                                       // Popping kernel argument #5...
  stiffness->pop(q1, k1, 5);                                                     // Popping kernel argument #6...
  resting->pop(q1, k1, 6);                                                       // Popping kernel argument #7...
  friction->pop(q1, k1, 7);                                                      // Popping kernel argument #8...
  mass->pop(q1, k1, 8);                                                          // Popping kernel argument #9...
  index_PR->pop(q1, k1, 9);                                                     // Popping kernel argument #11...
  index_PU->pop(q1, k1, 10);                                                     // Popping kernel argument #12...
  index_PL->pop(q1, k1, 11);                                                     // Popping kernel argument #13...
  index_PD->pop(q1, k1, 12);                                                     // Popping kernel argument #14...
  freedom->pop(q1, k1, 13);                                                      // Popping kernel argument #15...

  position->push(q1, k2, 0);                                                     // Pushing kernel argument #0...
  color->push(q1, k2, 1);                                                        // Pushing kernel argument #1...
  velocity->push(q1, k2, 2);                                                     // Pushing kernel argument #3...
  acceleration->push(q1, k2, 3);                                                 // Pushing kernel argument #4...
  gravity->push(q1, k2, 4);                                                      // Pushing kernel argument #5...
  stiffness->push(q1, k2, 5);                                                    // Pushing kernel argument #6...
  resting->push(q1, k2, 6);                                                      // Pushing kernel argument #7...
  friction->push(q1, k2, 7);                                                     // Pushing kernel argument #8...
  mass->push(q1, k2, 8);                                                         // Pushing kernel argument #9...
  index_PR->push(q1, k2, 9);                                                    // Pushing kernel argument #11...
  index_PU->push(q1, k2, 10);                                                    // Pushing kernel argument #12...
  index_PL->push(q1, k2, 11);                                                    // Pushing kernel argument #13...
  index_PD->push(q1, k2, 12);                                                    // Pushing kernel argument #14...
  freedom->push(q1, k2, 13);                                                     // Pushing kernel argument #15...

  k2->execute(q1, WAIT);

  position->pop(q1, k2, 0);                                                      // Popping kernel argument #0...
  color->pop(q1, k2, 1);                                                         // Popping kernel argument #1...
  velocity->pop(q1, k2, 2);                                                      // Popping kernel argument #3...
  acceleration->pop(q1, k2, 3);                                                  // Popping kernel argument #4...
  gravity->pop(q1, k2, 4);                                                       // Popping kernel argument #5...
  stiffness->pop(q1, k2, 5);                                                     // Popping kernel argument #6...
  resting->pop(q1, k2, 6);                                                       // Popping kernel argument #7...
  friction->pop(q1, k2, 7);                                                      // Popping kernel argument #8...
  mass->pop(q1, k2, 8);                                                          // Popping kernel argument #9...
  index_PR->pop(q1, k2, 9);                                                     // Popping kernel argument #11...
  index_PU->pop(q1, k2, 10);                                                     // Popping kernel argument #12...
  index_PL->pop(q1, k2, 11);                                                     // Popping kernel argument #13...
  index_PD->pop(q1, k2, 12);                                                     // Popping kernel argument #14...
  freedom->pop(q1, k2, 13);                                                      // Popping kernel argument #15...
