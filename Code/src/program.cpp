...
void setup()
{
  ...
  for (j = 0; j < SIZE_Y; j++)
  {
    ...
    for (i = 0; i < SIZE_X; i++)
    {
      ...
      stiffness->x[i + SIZE_X*j] = 150000.0f;                                   // Setting "x" stiffness...
      stiffness->y[i + SIZE_X*j] = 150000.0f;                                   // Setting "y" stiffness...
      stiffness->z[i + SIZE_X*j] = 150000.0f;                                   // Setting "z" stiffness...
