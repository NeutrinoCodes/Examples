...
void setup()
{
  ...
  for (j = 0; j < SIZE_Y; j++)
  {
    ...
    for (i = 0; i < SIZE_X; i++)
    {
      ...
      friction->x[i + SIZE_X*j] = 0.0f;                                        // Setting "x" friction...
      friction->y[i + SIZE_X*j] = 0.0f;                                        // Setting "y" friction...
      friction->z[i + SIZE_X*j] = 0.0f;                                        // Setting "z" friction...
  ...
  set_int1(index_PR, 10);                                                       // Setting kernel argument #11...
  set_int1(index_PU, 11);                                                       // Setting kernel argument #12...
  set_int1(index_PL, 12);                                                       // Setting kernel argument #13...
  set_int1(index_PD, 13);                                                       // Setting kernel argument #14...
  set_float4(freedom, 14);
}
...
void loop()
{
  ...
  push_int1(&index_PR->buffer, 10);                                             // Pushing kernel argument #11...
  push_int1(&index_PU->buffer, 11);                                             // Pushing kernel argument #12...
  push_int1(&index_PL->buffer, 12);                                             // Pushing kernel argument #13...
  push_int1(&index_PD->buffer, 13);                                             // Pushing kernel argument #14...
  push_float4(&freedom->buffer, 14);
  ...
  pop_int1(&index_PR->buffer, 10);                                              // Pushing kernel argument #11...
  pop_int1(&index_PU->buffer, 11);                                              // Pushing kernel argument #12...
  pop_int1(&index_PL->buffer, 12);                                              // Pushing kernel argument #13...
  pop_int1(&index_PD->buffer, 13);                                              // Pushing kernel argument #14...
  pop_float4(&freedom->buffer, 14);
