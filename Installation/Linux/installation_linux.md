...
The Neutrino examples can be successfully installed and used on Linux by using the **VScode** editor toolchain or manually from a command shell.
...
Congratulations, you have installed the Neutrino examples on Linux within the VScode toolchain!
...
Into the Neutrino examples project directory, create a configuration script file called `configure_linux` and edit it by adding the following command lines:\
`cmake -B"./cmake" -H"./" \`\
...
Congratulations, you have installed the Neutrino examples on Linux within the command shell toolchain!