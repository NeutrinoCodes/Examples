...
int main ()
{
  ...
  nu::projection_mode              P              = nu::NU_MODE_MONO;                               // OpenGL projection mode.

  // OPENCL:
  nu::opencl*                      cl             = new nu::opencl (nu::NU_GPU);                    // OpenCL context.
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////
  S->addsource (std::string (SHADER_HOME) + std::string (SHADER_VERT), nu::NU_VERTEX);              // Setting shader source file...
  S->addsource (std::string (SHADER_HOME) + std::string (SHADER_GEOM), nu::NU_GEOMETRY);            // Setting shader source file...
  S->addsource (std::string (SHADER_HOME) + std::string (SHADER_FRAG), nu::NU_FRAGMENT);            // Setting shader source file...
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    cl->execute (K1, nu::NU_WAIT);                                                                  // Executing OpenCL kernel...
    cl->execute (K2, nu::NU_WAIT);                                                                  // Executing OpenCL kernel...
    ...
    gl->plot (S, nu::NU_MODE_MONO);                                                                 // Plotting shared arguments...
