...
#define NM            "Neutrino - Gravity"                                                           // Window name.
...
int main ()
{
  ...
  while(!gl->closed ())                                                                              // Opening window...
  {
    ...
    hud->input ("Node mass:              ", "[kg]         ", "m", &m);                               // Adding input parameter...
    hud->input ("Elastic constant:       ", "[kg/s^2]     ", "K", &K);                               // Adding input parameter...
    hud->input ("Damping constant:       ", "[kg*s*m]     ", "B", &B);                               // Adding input parameter...
    hud->input ("Nucleus radius:         ", "[m]          ", "R0", &R0);                             // Adding input parameter...
