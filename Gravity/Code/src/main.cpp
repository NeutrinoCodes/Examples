...
int main ()
{
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    hud->parameter ("Node mass:              ", "[kg]         ", "m", &m);                          // Adding parameter...
    hud->parameter ("Elastic constant:       ", "[kg/s^2]     ", "K", &K);                          // Adding parameter...
    hud->parameter ("Damping constant:       ", "[kg*s*m]     ", "B", &B);                          // Adding parameter...
    hud->parameter ("Nucleus radius:         ", "[m]          ", "R0", &R0);                        // Adding parameter...
