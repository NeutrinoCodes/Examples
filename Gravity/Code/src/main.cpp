  ...
  for(k = 0; k < nodes_z; k++)
  {
    for(j = 0; j < nodes_y; j++)
    {
      for(i = 0; i < nodes_x; i++)
      {
        ...
        resting->data[gid].x      = x_min + i*dx;;                                                  // Setting "x" resting position...
        resting->data[gid].y      = y_min + j*dy;                                                   // Setting "y" resting position...
        resting->data[gid].z      = z_min + k*dz;                                                   // Setting "z" resting position...
