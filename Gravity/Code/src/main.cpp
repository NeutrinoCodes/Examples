...
int main ()
{
  ...
  float     dt                 = 0.1* dt_critical;                                                  // Simulation time step [s].
  ...
  // LINK PROPERTIES:
  float     K                  = E/40.0;                                                            // Space elastic constant [kg/s^2].
  float     C                  = mu*dx*dy*dz;                                                       // Space damping [kg*s*m].
  float1*   friction           = new float1 ();                                                     // Friction.
  float1*   resting            = new float1 ();                                                     // Resting distance [m].
  ...
  std::cout << "Simulation time step = " << dt << "[s]" << std::endl;
  ...
  for(k = 0; k < nodes_z; k++)
  {
    for(j = 0; j < nodes_y; j++)
    {
      for(i = 0; i < nodes_x; i++)
      {
        ...
        freedom->data[gid]        = 1.0;                                                            // Setting freedom flag...
        ...
        color->data[gid].x        = 0.01*(rand () % 100);                                           // Setting "x" initial color...
        color->data[gid].y        = 0.01*(rand () % 100);                                           // Setting "y" initial color...
        color->data[gid].z        = 0.01*(rand () % 100);                                           // Setting "z" initial color...
        color->data[gid].w        = 1.0;                                                            // Setting "w" initial color...

        mass->data[gid]           = m;                                                              // Setting mass...

        // Setting initial link properties:
        stiffness->data[gid]      = K;                                                              // Setting stiffness...
        resting->data[gid]        = dx;                                                             // Setting "x" resting position...
        ...
        {
          freedom->data[gid] = 0.0;                                                                 // Setting freedom...
        }
  ...
  K1->setarg (dt, 18);                                                                              // Setting time step kernel argument...
  ...
  K2->setarg (dt, 18);                                                                              // Setting time step kernel argument...
  ...
  Q->write (dt, 18);                                                                                // Writing time step data on queue...
