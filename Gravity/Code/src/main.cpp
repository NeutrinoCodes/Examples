  ...
  for(k = 0; k < nodes_z; k++)
  {
    for(j = 0; j < nodes_y; j++)
    {
      for(i = 0; i < nodes_x; i++)
      {
        ...
        depth->data[gid].x        = 0.01f*(rand () % 100);                                          // Setting "x" initial color...
        depth->data[gid].y        = 0.01f*(rand () % 100);                                          // Setting "y" initial color...
        depth->data[gid].z        = 0.01f*(rand () % 100);                                          // Setting "z" initial color...
