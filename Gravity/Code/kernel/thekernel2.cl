                        ...
                        __global float*     time)                                                   // Simulation time step [s].
{
        ...
        ///////////////////////////// SYNERGIC MOLECULE: NEIGHBOUR DISPATCHES ////////////////////////
        //////////////////////////////////////////////////////////////////////////////////////////////
        dv_R = v_R - v;                                                                             // Right neighbour dispatch [m/s].
        dv_U = v_U - v;                                                                             // Up neighbour dispatch [m/s].
        dv_F = v_F - v;                                                                             // Front neighbour dispatch [m/s].
        dv_L = v_L - v;                                                                             // Left neighbour dispatch [m/s].
        dv_D = v_D - v;                                                                             // Down neighbour dispatch [m/s].
        dv_B = v_B - v;                                                                             // Back neighbour dispatch [m/s].

        //////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////// SYNERGIC MOLECULE: VISCOUS FORCE ///////////////////////////
        //////////////////////////////////////////////////////////////////////////////////////////////
        // Elastic force applied to the particle:
        Fv = 100.0f*(B_R*dv_R + B_U*dv_U + B_F*dv_F + B_L*dv_L + B_D*dv_D + B_B*dv_B);                    // Computing friction force [N]...
